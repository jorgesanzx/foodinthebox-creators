...
accountsUIBootstrap3.map('es', {
  ...
  errorMessages: {
    ...
    usernameTooShort: 'El nombre de usuario tiene que tener 3 caracteres como' +
    ' mínimo',
    passwordTooShort: 'La contraseña tiene que tener 6 caracteres como mínimo',
    passwordsDontMatch: 'Las contraseñas no son iguales',
    newPasswordSameAsOld: 'La contraseña nueva y la actual no pueden ser' +
    ' iguales',
  },
});
